...
const DualForms = () => {
  return (
    <section className=" w-full bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white mt-20 p-10">

      {/* Form Container */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Membership Registration Form */}
        <div className="w-full">
          <h2 className="text-3xl font-semibold text-center text-[#0070C0] mb-4">
            Membership Registration Form
          </h2>
          <div className="w-full h-[550px] rounded-xl overflow-hidden shadow-lg border border-[#ec7e35] mt-10">
            <iframe
